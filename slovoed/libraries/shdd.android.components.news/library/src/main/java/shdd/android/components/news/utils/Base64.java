 ...
 *  <li>v1.3.5 - Added closeFlag to turn on and off line breaks. Fixed bug in input stream
...
public class Base64
{
    private static class DecompressibleInputStream extends ObjectInputStream {
        ...
        public DecompressibleInputStream(java.io.InputStream in) throws IOException {
            super(in);
        }
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        try {
            ...
            if( loader == null ){
                ois  = new DecompressibleInputStream( bais );
