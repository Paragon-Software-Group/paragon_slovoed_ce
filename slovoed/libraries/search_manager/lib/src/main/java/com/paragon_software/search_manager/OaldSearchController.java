...
public class OaldSearchController extends ParagonSearchController {

	private final static String partOfSpeechColor = "#333333";
	private final static String highLightColor = "#FDDD7F";

	OaldSearchController(SearchManagerAPI manager, ScreenOpenerAPI screenOpener, HintManagerAPI hintManager,
