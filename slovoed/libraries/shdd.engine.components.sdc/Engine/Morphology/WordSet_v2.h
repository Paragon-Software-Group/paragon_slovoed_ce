...
#ifndef __MORPHO_WORD_SET_V2_
#define __MORPHO_WORD_SET_V2_
...
public:
	...
	private:
		...
		std::map<std::string,std::vector <MorphoInflectionRulesSet_v2 *> > ::const_iterator itr;
		std::vector <MorphoInflectionRulesSet_v2 *>::const_iterator inflruleset_iter;
#else
		const STAT_VECTOR_SIZE_V2 *ptr;
#endif
	};
	...
	bool SearchWord(const MCHAR *word, WordRuleSetsIterator &iter,
							...
							const MorphoInflectionRulesSet_v2 * rsArray = NULL,
	...
	//
	///////////////////////////////////////////////////////////////////////////////////////////////////
	const MorphoInflectionRulesSet_v2* GetNextRuleSet(WordRuleSetsIterator &iter) const;
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef _ML_PARSER_
	bool Insert(const MCHAR *word,  MorphoInflectionRulesSet_v2* Mo);
#endif
...
private:
	...
	typedef std::map<std::string,std::vector <MorphoInflectionRulesSet_v2 *> > MapWords;
...
private:
	...
	const STAT_VECTOR_SIZE_V2	*RuleSetArray;
...
//	const Int32				*BlockSizeArray;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
#ifndef _ML_PARSER_
	void Init(	const void *ArchHeader,
