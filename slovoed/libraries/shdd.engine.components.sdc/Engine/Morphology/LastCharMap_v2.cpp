...
//
//////////////////////////////////////////////////////////////////////
RulesByLastChar_v2::RulesByLastChar_v2()
{
...
///
//////////////////////////////////////////////////////////////////////
void RulesByLastChar_v2::InsertOne(OneCallParameters *str, MCHAR lastchar, Int32 pos)
{
	/// запихиваем в массив
...
///
//////////////////////////////////////////////////////////////////////
void RulesByLastChar_v2::AddSingleRule(const MCHAR* precondition, const MCHAR* rule, const MorphoInflectionRulesSet_v2 *ruleset)
{
...
/// MorphoInflectionRulesSet (набора правил изменнения слова), 
...
///
//////////////////////////////////////////////////////////////////////
void RulesByLastChar_v2::AddRuleset(const MorphoData_v2 &morpho, const MorphoInflectionRulesSet_v2 *ruleset, const MorphoInflectionRulesSet_v2 *base_ruleset)
{
...
///
//////////////////////////////////////////////////////////////////////
const RulesByLastChar_v2::OneCallParameters* RulesByLastChar_v2::GetFirstRuleset(CallParamIterator &iter, MCHAR last_char) const
{
	iter.curIndex  = MORPHO_SWAP_32(lastCharMap[(UInt8)last_char  ].index);
	iter.lastIndex = MORPHO_SWAP_32(lastCharMap[(UInt8)last_char+1].index);

	// if records for this las char
	if ( iter.curIndex == iter.lastIndex )
	{
		// try to use default records list
		iter.curIndex  = MORPHO_SWAP_32(lastCharMap[0].index);
		iter.lastIndex = MORPHO_SWAP_32(lastCharMap[1].index);
	}
...
///
//////////////////////////////////////////////////////////////////////
const RulesByLastChar_v2::OneCallParameters* RulesByLastChar_v2::GetNextRuleset(CallParamIterator &iter) const
{
	// reached end ?
	if ( iter.curIndex == iter.lastIndex )
	{
		// is this default sequence?
		if ( iter.lastIndex == MORPHO_SWAP_32(lastCharMap[1].index) )
			return NULL;
		else
		{
			// try to use default records list
