...
///
///////////////////////////////////////////////////////////////////////////////////
Int32 MorphoData_v1::ApplyPrecondition(const MCHAR *word, const MCHAR **posBuf, const MCHAR* precondition)
{
...
///
///////////////////////////////////////////////////////////////////////////////////
const MCHAR* MorphoData_v1::InflectWord(const MCHAR *word, const MCHAR *precondition, const MCHAR *rule, MCHAR *buf, const MCHAR **pos)
{
const MCHAR				*w,*next;
Int32						i;
MCHAR					*b;
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::RestoreWord(const MCHAR *word_form, const MCHAR *precondition, const MCHAR *rule, Int32 rule_len, MCHAR* restored, Int32 onlyOneVariant)
{
const MCHAR				*w,*p;
MCHAR					*r;
Int32						left;
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::IsRuleApplyable(const MCHAR *word, const MorphoInflectionRulesSetHandle* ruleset_ptr, const MCHAR **posBuf,  Int32 flags) const
{
	// проверяли ли мы уже на предусловие этого правила
	bool checkedForThisPrecondition = false;

	const MorphoInflectionRulesSet_v1* ruleset = (const MorphoInflectionRulesSet_v1*)ruleset_ptr;
...
///
///////////////////////////////////////////////////////////////////////////////////
void MorphoData_v1::WordFormsIteratorInit(WordFormsIterator &iter, const MCHAR *wordPtr, const MorphoInflectionRulesSetHandle* ruleset, Int32 flags ) const
{
...
///
///////////////////////////////////////////////////////////////////////////////////
void MorphoData_v1::WordFormsIteratorInitW(WordFormsIterator &iter, const UInt16 *wordPtr, const MorphoInflectionRulesSetHandle* ruleset, Int32 flags ) const
{
#ifdef _ML_PARSER_
	return;
#else
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetNextWordForm(WordFormsIterator &iter, MCHAR *formBuf, const MCHAR**questionPtr, const MCHAR ** formNamePtr, bool *isSubTableName) const
{
const MorphoInflectionRule_v1   *rule;
const MorphoStateDescription_v1 *state;
...
UInt32 pos;
	...
	while(true)
	{
		...
		while ( pos >= ((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->rules.size() && iter.depth )
		{
			...
			{
				iter.cur_ruleset = Rule2RuleSetPtr(((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->rules[iter.vector[i]]);
				iter.cur_table   = ObjRef2Ptr(((const MorphoStateDescriptionTable_v1*)(iter.cur_table))->states[iter.vector[i]].table);
			}
		}

		// если уже поднялись до предела, а двигаться все еще некуда - обход уже закончен
		if ( pos >= ((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->rules.size() )
		{
			formBuf[0] = 0;
			return false;
		}
		...
		rule = &((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->rules[pos];

		// указаетель на описание текущей формы
		state = &(((const MorphoStateDescriptionTable_v1*)(iter.cur_table))->StateByIndex(pos));
	...
	if ( rule->IsLinkToRuleset() )
	{
		...
		iter.cur_ruleset = Rule2RuleSetPtr(((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->rules[pos]);
		iter.cur_table   = ObjRef2Ptr(((const MorphoStateDescriptionTable_v1*)(iter.cur_table))->states[pos].table);
	...
	else
	{
		...
		if ( chr_rule[0] )
		{
			...
			// получим форму слова
			InflectWord(iter.wordPtr, 
						McharRef2Ptr(((const MorphoInflectionRulesSet_v1*)(iter.cur_ruleset))->precondition),
						chr_rule,
						formBuf,
						iter.posBuf);
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetNextWordFormW(WordFormsIterator &iter, UInt16 *formBuf, const MCHAR**questionPtr, const MCHAR ** formNamePtr, bool *isSubTableName) const
{
#ifdef _ML_PARSER_
	return false;
#else
...
MCHAR	*buff;
	...
	buff = (MCHAR *)sldMemNew(MAX_WORD_LEN);
	if (!buff)
		return false;

	ret = GetNextWordForm (iter, buff, questionPtr, formNamePtr, isSubTableName);
	if (ret)
...
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetMorphoHeader(const MorphoDataHeader** aHeader) const
{
	if (!m_Header)
		return false;
...
///
///////////////////////////////////////////////////////////////////////////////////
void MorphoData_v1::WritingVersionIteratorInit (WritingVersionIterator &iter, const MCHAR *wordForm, UInt32 &length , bool strict) const
{
	UInt32 i;
...
///
///////////////////////////////////////////////////////////////////////////////////
void MorphoData_v1::WritingVersionIteratorInitW (WritingVersionIterator &iter, const UInt16 *wordForm, UInt32 &length , bool strict) const
{
#ifdef _ML_PARSER_
	return;
#else
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetNextWritingVersion (WritingVersionIterator &iter, MCHAR* outBuf) const
{
...
///
///////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetNextWritingVersionW (WritingVersionIterator &iter, UInt16* outBuf) const
{
#ifdef _ML_PARSER_
	return false;
#else
...
MCHAR	*buff;
	...
	ret = GetNextWritingVersion(iter, buff);
	if (ret)
...
///
///////////////////////////////////////////////////////////////////////////////////
void MorphoData_v1::BaseFormsIteratorInit (BaseFormsIterator &iter, const MCHAR *wordFormPtr, Int32 flags) const
{
	// save word pointer
...
/// @param     flags			 Флаги. 
***********************************************************************/
void MorphoData_v1::BaseFormsIteratorInitW (BaseFormsIterator &iter, const UInt16 *wordFormPtr, Int32 flags) const
{
#ifdef _ML_PARSER_
	return;
#else
...
///
//////////////////////////////////////////////////////////////////////////////////////
bool MorphoData_v1::GetNextBaseForm (BaseFormsIterator &iter, MCHAR *baseFormBuf, const MorphoInflectionRulesSetHandle** rulesetPtr) const
{
	////////////////////////////////////////////////////
	//
	// fool protection
	...
	*/ 
	...
	const MorphoInflectionRulesSet_v1* savedRuleset[RULES_CACHE_SIZE];
	...
	while( iter.call_param )
	{
		...
		if ( ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->pre_last && ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->pre_last != iter.pre_last_char )
		{
			// не удалось восстановить слово
			wordWasRestored = false;
		}
		// мы уже имеем слово восстановленное на предыдущем шаге?
		else if ( wordWasRestored && ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->matchPrevious && passesCount == 1 )
		{
...
#ifdef _ML_PARSER_
			                  ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->precondition, 
							  ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->rule, 
#else
							  McharRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->precondition), 
							  McharRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->rule), 
#endif
							  ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->rule_len,
							  baseFormBuf, 
							  ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->onlyOneVariant) )
		{
		...
		if ( wordWasRestored  &&  ( (savedRulesetNum != 0) || !(iter.flags & M_BASEFORMS_ONLY_DICTIONARY_WORDS) ) )
		{
			...
			for(passesCount = 0 ; morePasses ;  passesCount++)
			{
				...
				{
#ifdef _ML_PARSER_
					if( !IsRuleApplyable(baseFormBuf, ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset, iter.posBuf, M_RULE_TOPMOST_PRECONDITION | M_RULE_CLOSED_RULE_IS_OK ) )
						everythin_is_ok = false;
#else
					if( !IsRuleApplyable(baseFormBuf, ObjRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset), iter.posBuf, M_RULE_TOPMOST_PRECONDITION | M_RULE_CLOSED_RULE_IS_OK ) )
						everythin_is_ok = false;
#endif
				}
				...
				{
					WordSet_v1::WordRuleSetsIterator	rulesetsIter;
					const MorphoInflectionRulesSet_v1*	realRuleset;
...
#ifdef _ML_PARSER_
							if ( savedRuleset[k] == ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset )

								// есть такое правило!
								break;
#else

							if ( savedRuleset[k] == ObjRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset) )
...
#ifdef _ML_PARSER_
							if ( realRuleset == ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset )
								// есть такое правило!
								rulesetMatch = true;
#else
							if ( realRuleset == ObjRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset) )
								// есть такое правило!
								rulesetMatch = true;
#endif
						}
...
#ifdef _ML_PARSER_
					if ( rulesetPtr )
						*rulesetPtr = ((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset;
#else
					if ( rulesetPtr )
						*rulesetPtr = ObjRef2Ptr(((const RulesByLastChar_v1::OneCallParameters*)(iter.call_param))->ruleset);
#endif
...
* @see BaseFormsIteratorInit(), BaseFormsIterator
***********************************************************************/
bool MorphoData_v1::GetNextBaseFormW (BaseFormsIterator &iter, UInt16 *baseFormBuf, const MorphoInflectionRulesSetHandle** rulesetPtr) const
{
#ifdef _ML_PARSER_
	return false;
#else
...
MCHAR	*buff;
	...
	ret = GetNextBaseForm (iter, buff, rulesetPtr);
	if (ret)
...
///
///////////////////////////////////////////////////////////////////////////////////
const MCHAR* MorphoData_v1::ClassNameByRulesetPtr(const MorphoInflectionRulesSetHandle* ruleset_ptr) const
{
const MorphoClass_v1* cls;
ClassesIterator    citer;
MorphoClass_v1::InflTablesIterator infliter;
STAT_VECTOR_SIZE_V1 size_of_first_layer;
	...
	size_of_first_layer = (STAT_VECTOR_SIZE_V1)(ruleset->rules.size());
...
*
***********************************************************************************/
void MorphoData_v1::GetBriefClassNameByRulesetPtr(const MorphoInflectionRulesSetHandle* ruleset, MCHAR* buf) const
{
...
*
***********************************************************************************/
void MorphoData_v1::GetBriefClassNameByRulesetPtrW(const MorphoInflectionRulesSetHandle* ruleset, UInt16* buf) const
{
#ifdef _ML_PARSER_
	return;
#else
...
*
***********************************************************************************/
void MorphoData_v1::GetFullClassNameByRulesetPtr(const MorphoInflectionRulesSetHandle* ruleset, MCHAR* buf) const
{
...
*
***********************************************************************************/
void MorphoData_v1::GetFullClassNameByRulesetPtrW(const MorphoInflectionRulesSetHandle* ruleset, UInt16* buf) const
{
#ifdef _ML_PARSER_
	return;
#else
...
///
///////////////////////////////////////////////////////////////////////////////////
const MorphoStateDescriptionTableHandle* MorphoData_v1::GetTableByRulesetPtr(const MorphoInflectionRulesSetHandle* ruleset_ptr) const
{
const MorphoClass_v1* cls;
ClassesIterator    citer;
MorphoClass_v1::InflTablesIterator infliter;
...
MorphoInflectionRulesSet_v1* ruleset = (MorphoInflectionRulesSet_v1*)ruleset_ptr;
...
bool MorphoData_v1::Init(CSDCReadMy &aMorphology)
{
...
//	MorphoData::data_size   = 0;
	...
	MorphoData_v1::character_attributes_table  = 0;
	MorphoData_v1::to_upper_table              = 0;
	MorphoData_v1::to_lower_table              = 0;

	// читаем заголовок
	auto res = aMorphology.GetResource(MORPHODATA_RES_HEADER, 0);
	if (res != eOK)
		return false;
	m_resHeader = res.resource();
	m_Header = (MorphoDataHeader *)m_resHeader.ptr();
	...
	// Считываем несжатые строки
	if ((res = aMorphology.GetResource(MORPHODATA_RES_TEXT, 0)) != eOK)
		return false;
	m_resText = res.resource();
	
	/*
	// Считываем несжатые строки
	if (sldGetResource(&m_resRulesSet, &m_database, MORPHODATA_RES_RULESSET, 0)!=eOK)
		return false;
	*/
	...
	// Савельев: считываем несколько ресурсов с правилами и создаем из них один
	{
		UInt16 count = 0;
		UInt32 len = 0;
		CSDCReadMy::ResourceHandle rulesSetArray[8]; // XXX: почему 8?
		while ((rulesSetArray[count] = aMorphology.GetResource(MORPHODATA_RES_RULESSET, count)) == eOK)
		{
			len += rulesSetArray[count].size();
			count++;
		}
		if (!count)
			return false;

		if (!m_resRulesSet.resize(sld2::default_init, len))
			return false;

		UInt8* ptr = m_resRulesSet.data();
		for (UInt16 i=0;i<count;i++)
		{
			sldMemMove(ptr, rulesSetArray[i].ptr(), rulesSetArray[i].size());
			ptr += rulesSetArray[i].size();
		}
	}

	// Считываем классы.
	if ((res = aMorphology.GetResource(MORPHODATA_RES_CLASS, 0)) != eOK)
		return false;
	m_resClass = res.resource();

	// Считываем таблицу с последними символами слов.
	if ((res = aMorphology.GetResource(MORPHODATA_RES_LASTCHAR, 0)) != eOK)
		return false;
	m_resLastChar = res.resource();
...
//	MorphoData::data_struct = m_resRulesSet.Pointer;
	...
	MorphoData_v1::character_attributes_table  = m_Header->character_attributes_array;
	MorphoData_v1::to_upper_table              = m_Header->to_upper_array;
	MorphoData_v1::to_lower_table              = m_Header->to_lower_array;
	...
	while (true)
	{
		...
		UInt16 count = m_resCharMap[m_resCharMapIdx].size()/sizeof(RulesByLastChar_v1::OneCallParameters);
		lastCharMap.callParams_used+=count;
		lastCharMap.AddBlock((RulesByLastChar_v1::OneCallParameters*)m_resCharMap[m_resCharMapIdx].ptr(), count);
		m_resCharMapIdx++;
	}
...
*/
	...
	M_ASSERT(lastCharMap.callParams_used == m_Header->num_items_in_LCM);

	// Копируем последние символы в структуру соответствующего класса.
	sldMemMove(lastCharMap.lastCharMap, m_resLastChar.ptr(), sizeof(lastCharMap.lastCharMap));
...
//		ArchiveBlockArray[m_resWordSetIdx] = (pBlockType)m_resWordSet[m_resWordSetIdx].Pointer;
//		MemMove(ArchiveBlockArray+size, m_resWordSet[m_resWordSetIdx].Pointer, m_resWordSet[m_resWordSetIdx].Len);
	}
	...
	// Считываем ресурс с сжатыми правилами.
	if ((res = aMorphology.GetResource(MORPHODATA_RES_RUL2, 0)) != eOK)
		return false;
	m_resRules2 = res.resource();

	// Считываем ресурс с индексом быстрого доступа.
	if ((res = aMorphology.GetResource(MORPHODATA_RES_QAINDEX, 0)) != eOK)
		return false;
	m_resQAIndex = res.resource();
	...
	// Считываем ресурс с таблицей
	if ((res = aMorphology.GetResource(MORPHODATA_RES_TABLE, 0)) != eOK)
		return false;
	m_resTable = res.resource();
	
	/*
	// В версии ядра 105 поле m_Header->MaximumPreconditionLength отсутствует
	MAX_POS_BUF_SIZE = MORPHO_SWAP_16(m_Header->MaximumPreconditionLength);
	if (!MAX_POS_BUF_SIZE)
		MAX_POS_BUF_SIZE = 1024;
	*/
	
	MAX_POS_BUF_SIZE = 256;

	words.Init( (UInt32 *)m_resArchHeader.ptr(),
				m_resWordSet,
				m_resQAIndex.ptr(),
				(STAT_VECTOR_SIZE_V1*)m_resRules2.ptr(),
				m_resTree.ptr(),
				this);
...
UInt32 MorphoData_v1::GetNumberOfBaseForms(void) const
{
	if (m_Header)
...
UInt32 MorphoData_v1::GetNumberOfWordForms(void) const
{
	if (m_Header)
...
bool MorphoData_v1::IsMorphologySimple(void) const
{
	if (m_Header)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
struct EnumParamStruct_v1
{
	const MorphoData_v1*	This;
	EnumCallBackT*			callback;
	void*					callbackParam;
};

bool WalkRuleSet_v1(const MCHAR* word, const MorphoInflectionRulesSet_v1* ruleset, MCHAR**	rulesCache, Int32& nCacheSize, void* param)
{
	const MorphoData_v1* This = ((EnumParamStruct_v1*)param)->This;
	...
	while(rule != ruleset->RulesEnd())
	{
		if ( rule->IsLinkToRuleset() )
		{
			const MorphoInflectionRulesSet_v1* subset;
			subset = This->Rule2RuleSetPtr(*rule);
			WalkRuleSet_v1(word, subset, rulesCache, nCacheSize, param);
		}
		else if ( This->Rule2MCharPtr(*rule)[0] )
		{
			...
			if(i == nCacheSize)
			{
				...
				((EnumParamStruct_v1*)param)->callback(form, ((EnumParamStruct_v1*)param)->callbackParam);
			}
		}
		rule++;
	}
...
bool EnumWordsCallBack_v1(const MCHAR* word, WordSet_v1::WordRuleSetsIterator &iter, void* param)
{
	...
	const MorphoInflectionRulesSet_v1* ruleset;
	while ( (ruleset = This->words.GetNextRuleSet(iter)) )
		WalkRuleSet_v1(word, ruleset, rulesCache, nCacheSize, param);

	return true;
}

bool MorphoData_v1::Enum(bool bAllForms, EnumCallBackT* callback, void* param) const
{
	EnumParamStruct_v1 eps = {this, callback, param};

	return words.EnumWords(EnumWordsCallBack_v1, &eps);
}

//**********************************************************************************************

struct EnumPartialParamStruct_v1
{
	const MorphoData_v1*	This;
...
bool PartialWalkRuleSet_v1(const MCHAR* word, const MorphoInflectionRulesSet_v1* ruleset, MCHAR** rulesCache, Int32& nCacheSize, void* param)
{
	const MorphoData_v1* This = ((EnumPartialParamStruct_v1*)param)->This;
	...
	while (rule != ruleset->RulesEnd())
	{
		if ( rule->IsLinkToRuleset() )
		{
			const MorphoInflectionRulesSet_v1* subset;
			subset = This->Rule2RuleSetPtr(*rule);
			PartialWalkRuleSet_v1(word, subset, rulesCache, nCacheSize, param);
		}
		else if ( This->Rule2MCharPtr(*rule)[0] )
		{
			const MCHAR* sRule = This->Rule2MCharPtr(*rule);
			...
			if(i == nCacheSize)
			{
				...
				((EnumPartialParamStruct_v1*)param)->callback(form, ((EnumPartialParamStruct_v1*)param)->BaseForm, ((EnumPartialParamStruct_v1*)param)->callbackParam);
			}
		}
		rule++;
	}
...
bool EnumPartialWordsCallBack_v1(const MCHAR* word, WordSet_v1::WordRuleSetsIterator &iter, void* param)
{
	MCHAR* rulesCache[1000] = {0};
	Int32 nCacheSize = 0;
	MCHAR baseForm[MAX_WORD_LEN] = {0};
	EnumPartialParamStruct_v1* pParam = (EnumPartialParamStruct_v1*)param;
	...
	const MorphoInflectionRulesSet_v1* ruleset = 0;
	while ((ruleset = pParam->This->words.GetNextRuleSet(iter)))
	{
		PartialWalkRuleSet_v1(word, ruleset, rulesCache, nCacheSize, param);
	}
...
bool MorphoData_v1::EnumPartial(EnumPartialCallBackT* callback, UInt32 aBaseFormIndexFirst, UInt32 aBaseFormIndexLast, void* aParam) const
{
	EnumPartialParamStruct_v1 eps;
	...
	return words.EnumWords(EnumPartialWordsCallBack_v1, &eps);
}
