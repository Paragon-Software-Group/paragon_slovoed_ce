...
public class PictureInfo extends ExternalBaseInfo
{

  private final String mSdcId;

  public PictureInfo( int langFrom, @NonNull DictionaryLocation location, @NonNull String sdcId )
  {
  ...
  public String toString()
  {
    ...
    return "PictureInfo{" + "langFrom=" + langFrom + ", location=" + location + ", sdcId=" + mSdcId + '}';
  }
}
